/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ae2f934740d362cb817c0f971ec57f4a)
// Runtime types generated with workerd@1.20260515.1 2026-03-10 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	CMS_MANIFEST: R2Bucket;
	BOOK_FILES: R2Bucket;
	ASSETS: Fetcher;
	AES_SECRET_KEY: string;
	API_AUTH_TOKEN: string;
	OSTAY_API_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AES_SECRET_KEY" | "API_AUTH_TOKEN" | "OSTAY_API_KEY">> {}
}
